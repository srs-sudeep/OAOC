...
const translations = {
  en: {
    ...
    'hero.subtitle': 'Digital Chhattisgarh Initiative - Serving Citizens Through Technology',
    'hero.description': 'Access all Chhattisgarh government services from a single platform. Empowering citizens with digital governance for a prosperous Chhattisgarh.',
    'departments.title': 'Government Departments',
    'departments.subtitle': 'Explore various Chhattisgarh government departments and their services',
  ...
  hi: {
    ...
    'hero.subtitle': 'डिजिटल छत्तीसगढ़ पहल - प्रौद्योगिकी के माध्यम से नागरिकों की सेवा',
    'hero.description': 'एक ही मंच से सभी छत्तीसगढ़ सरकारी सेवाओं तक पहुंच। समृद्ध छत्तीसगढ़ के लिए डिजिटल गवर्नेंस के साथ नागरिकों को सशक्त बनाना।',
    'departments.title': 'सरकारी विभाग',
    'departments.subtitle': 'विभिन्न छत्तीसगढ़ सरकारी विभागों और उनकी सेवाओं का अन्वेषण करें',
