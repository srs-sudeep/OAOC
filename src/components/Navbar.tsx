...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="flex items-center space-x-3 group" onClick={closeMobileMenu}>
              <div className="w-10 h-10 bg-gradient-to-r from-blue-900 to-orange-500 rounded-full flex items-center justify-center transform group-hover:scale-110 transition-transform duration-200 shadow-md">
      ...
      {/* Mobile Menu Panel */}
      <div className={`fixed top-16 right-0 z-50 w-80 max-w-sm bg-white shadow-2xl border-l-4 h-[100vh] border-orange-500 transform transition-transform duration-300 ease-in-out md:hidden ${
