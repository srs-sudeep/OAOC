        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center animate-fade-in">
            <div className="mb-8 animate-slide-up">
              <div className="inline-flex items-center px-6 py-3 bg-white/10 backdrop-blur-md rounded-full text-sm font-medium border border-white/20 shadow-lg">
                ...
                <span className="bg-gradient-to-r from-white to-orange-200 bg-clip-text text-transparent font-bold">
                  {language === 'en' ? 'Government of Chhattisgarh' : 'छत्तीसगढ़ सरकार'}
                </span>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center animate-slide-up stagger-delay-3 mb-12">
              <Link to="/departments">
                <Button size="lg" className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-12 py-6 text-xl font-semibold transform hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-orange-500/25 rounded-xl">
                  {t('nav.departments')}
              ...
              <Link to="/about">
                <Button size="lg" variant="outline" className="border-2 border-white/30 text-black hover:bg-white/10 backdrop-blur-sm px-12 py-6 text-xl font-semibold transform hover:scale-105 transition-all duration-300 shadow-2xl rounded-xl">
                  {t('button.learnMore')}
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center p-8 rounded-2xl bg-gradient-to-br from-orange-50 to-orange-100 shadow-xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-300 animate-scale-in stagger-delay-1 border border-orange-200">
              ...
              <div className="text-4xl font-bold text-orange-600 mb-2">2.55 Cr</div>
              <p className="text-gray-700 font-semibold">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 animate-scale-in">
              <div className="flex items-center mb-4">
                ...
                <h4 className="ml-3 font-bold text-gray-800">{language === 'en' ? '24/7 Availability' : '24/7 उपलब्धता'}</h4>
              </div>
              <p className="text-gray-600">{language === 'en' ? 'Access services anytime, anywhere' : 'कभी भी, कहीं भी सेवाओं तक पहुंच'}</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 animate-scale-in stagger-delay-1">
              <div className="flex items-center mb-4">
                ...
                <h4 className="ml-3 font-bold text-gray-800">{language === 'en' ? 'Instant Processing' : 'तुरंत प्रसंस्करण'}</h4>
              </div>
              <p className="text-gray-600">{language === 'en' ? 'Fast and efficient service delivery' : 'तेज़ और कुशल सेवा वितरण'}</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 animate-scale-in stagger-delay-2">
              <div className="flex items-center mb-4">
                ...
                <h4 className="ml-3 font-bold text-gray-800">{language === 'en' ? 'Real-time Tracking' : 'वास्तविक समय ट्रैकिंग'}</h4>
              </div>
              <p className="text-gray-600">{language === 'en' ? 'Monitor your application status live' : 'अपने आवेदन की स्थिति लाइव देखें'}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-8 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 animate-scale-in stagger-delay-1">
              ...
              <p className="text-blue-100 text-lg font-bold mb-2">1800-233-4567</p>
              <p className="text-blue-200 text-sm">{language === 'en' ? 'Toll Free 24/7' : 'टोल फ्री 24/7'}</p>
            </div>
            ...
            <div className="text-center p-8 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 animate-scale-in stagger-delay-2">
              ...
              <p className="text-blue-200 text-sm mt-2">{language === 'en' ? 'Quick Response Guaranteed' : 'त्वरित उत्तर की गारंटी'}</p>
            </div>
          </div>
        </div>
      </section>
