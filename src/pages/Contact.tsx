              ...
              <div className="flex items-center mb-8">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 mt-1">
                    {language === "en"
                      ? "Chhattisgarh Government Digital Services"
                      : "छत्तीसगढ़ सरकार डिजिटल सेवाएं"}
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-2xl shadow-xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span>
                    {language === "en" ? "Police Emergency" : "पुलिस आपातकाल"}
                  </span>
                ...
                <div className="flex justify-between items-center">
                  <span>
                    {language === "en" ? "Fire Emergency" : "अग्निशमन आपातकाल"}
                  </span>
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                name:
                  language === "en" ? "Agriculture Department" : "कृषि विभाग",
                phone: "0771-2236-789",
              ...
              {
                name:
                  language === "en" ? "Health Department" : "स्वास्थ्य विभाग",
                phone: "0771-2237-890",
              ...
              {
                name:
                  language === "en" ? "Education Department" : "शिक्षा विभाग",
                phone: "0771-2238-901",
              ...
              {
                name:
                  language === "en" ? "Transport Department" : "परिवहन विभाग",
                phone: "0771-2239-012",
              ...
              <div
                key={index}
                className={`bg-white rounded-xl shadow-lg p-6 border-l-4 border-${dept.color}-500 hover:shadow-xl transition-all duration-300 hover:-translate-y-1`}
              >
