          ...
          <div className="animate-fade-in">
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20">
                ...
                <span className="text-blue-200 ml-2">
                  {language === "en" ? "Digital Services" : "डिजिटल सेवाएं"}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          <div className="text-center p-6 bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-sm text-gray-600">
              {language === "en"
                ? "Official departments of Chhattisgarh Government"
                : "छत्तीसगढ़ सरकार के आधिकारिक विभाग"}
            </p>
          </div>
          ...
          <div className="text-center p-6 bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-sm text-gray-600">
              {language === "en"
                ? "Apply online for government schemes"
          ...
          <div className="text-center p-6 bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-sm text-gray-600">
              {language === "en"
                ? "Comprehensive services for all citizens"
                : "सभी नागरिकों के लिए व्यापक सेवाएं"}
            </p>
          </div>
          ...
          <div className="text-center p-6 bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-sm text-gray-600">
              {language === "en"
                ? "Government verified and secure platform"
                : "सरकारी सत्यापित और सुरक्षित प्लेटफॉर्म"}
            </p>
          </div>
        </div>
